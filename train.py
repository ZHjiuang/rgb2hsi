...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_type', type=str, default='apple', help='data_type, 5 datasets')
    ...
    parser.add_argument('--save_by_epoch', type=int, default=2, help='interval between model checkpoints (by epochs)')
    ...
    # GPU parameters
    parser.add_argument('--device', type=str, default="0", help='True for more than 1 GPU')
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='True for unchanged input data type')
    # Training parameters
    parser.add_argument('--epochs', type=int, default=3,
                        help='number of epochs of training that ensures 100K training iterations')
    parser.add_argument('--batch_size', type=int, default=2, help='size of the batches, 8 is recommended')
    ...
    parser.add_argument('--lr_decrease_epoch', type=int, default=3000,
                        help='lr decrease at certain epoch and its multiple')
    parser.add_argument('--lr_decrease_iter', type=int, default=50000,
                        help='lr decrease at certain epoch and its multiple')
    ...
    parser.add_argument('--out_channels', type=int, default=9, help='output channels for generator')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot_train', type=str, default='H:\\HSI_online\\HSI', help='baseroot')
    parser.add_argument('--baseroot_val', type=str, default='./dataset/CAVE/val', help='baseroot')
    parser.add_argument('--save_path', type=str, default='H:\\HSI_online', help='save_path')
